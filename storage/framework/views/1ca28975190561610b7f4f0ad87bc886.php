<?php $__env->startSection('title', 'Membership Details'); ?>
            ...
            <div class="flex items-center space-x-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-slate-500">For Patient: <span
                            class="font-bold text-slate-700 dark:text-slate-300"><?php echo e($patient->full_name); ?></span></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5">
                    ...
                    <p class="text-xl font-black text-emerald-600 dark:text-emerald-400">
                        ₹<?php echo e(number_format($patient->membership_fee, 2)); ?></p>
                </div>
                <div class="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Payment Method</p>
                    <p class="text-xl font-black text-slate-700 dark:text-white"><?php echo e($patient->payment_method ?? 'N/A'); ?></p>
                </div>
            </div>

            <?php if($patient->payment_screenshot): ?>
                <div class="mt-8">
                    ...
                    <div class="relative group max-w-sm">
                        <img src="<?php echo e(route('storage.bridge', ['path' => $patient->payment_screenshot])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\membership\show.blade.php ENDPATH**/ ?>