            ...
            <div
                ...
                <div class="mt-4 grid grid-cols-2 gap-y-2 text-[10px] font-bold uppercase tracking-tight">
                    <div class="flex items-center text-slate-500">
                        ...
                        <span
                            data-live-sync="earnings.today_ta"><?php echo e(($earnings['salary_mode'] ?? 'tab') === 'dab' ? 'SERVICE' : 'TA'); ?>:
                            ₹<?php echo e(number_format($earnings['today_breakdown']['ta'], 2)); ?></span>
                    </div>
                    <div class="flex items-center text-emerald-500">
                        <div class="w-2 h-2 rounded-full bg-emerald-500/40 mr-1.5"></div>
                        <span data-live-sync="earnings.today_medicines">M:
                            ₹<?php echo e(number_format($earnings['today_breakdown']['medicines'], 2)); ?></span>
                    </div>
                    <div class="flex items-center text-purple-500">
                        <div class="w-2 h-2 rounded-full bg-purple-500/40 mr-1.5"></div>
                        <span data-live-sync="earnings.today_pathology">P:
                            ₹<?php echo e(number_format($earnings['today_breakdown']['pathology'], 2)); ?></span>
                    </div>
                    <div class="flex items-center text-amber-500">
                        <div class="w-2 h-2 rounded-full bg-amber-500/40 mr-1.5"></div>
                        <span data-live-sync="earnings.today_membership">MB:
                            ₹<?php echo e(number_format($earnings['today_breakdown']['membership'], 2)); ?></span>
                    </div>
                </div>
            </div>
