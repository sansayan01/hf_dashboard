<?php $__env->startSection('title', 'Inventory Overview'); ?>
<?php $__env->startSection('header_title', 'NGO Pharmacy Inventory'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div
            ...
            <div>
                <h2 class="text-2xl font-black text-slate-800 dark:text-white"><?php echo e(auth()->user()->name); ?></h2>
                <div class="flex items-center space-x-2 text-xs font-bold text-slate-500">
                    <span
                        class="bg-blue-100 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400 px-2 py-0.5 rounded uppercase tracking-wider"><?php echo e(auth()->user()->designation ?? 'User'); ?></span>
                    <span>•</span>
                    <span><?php echo e(auth()->user()->camp ? auth()->user()->camp->name : 'Head Office'); ?></span>
                    <span>•</span>
                    <span><?php echo e(now()->format('l, d M Y')); ?></span>
                </div>
            </div>

            <!-- Quick Navigation -->
            <div class="flex flex-wrap items-center gap-2">
                <?php if(auth()->user()->hasPermission('inventory.manage_warehouses')): ?>
                    <a href="<?php echo e(route('inventory.warehouses.index')); ?>"
                    ...
                    <a href="<?php echo e(route('inventory.camps.index')); ?>"
                ...
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('inventory.manage_sponsors')): ?>
                    <a href="<?php echo e(route('inventory.sponsors.index')); ?>"
                ...
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('inventory.manage_medicines')): ?>
                    <a href="<?php echo e(route('inventory.medicines.index')); ?>"
                        ...
                        Registry</a>
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('inventory.view_transactions')): ?>
            ...
            <div
                ...
                <div class="z-10">
                    ...
                    <div class="text-2xl font-black text-slate-800 dark:text-white truncate">
                        ₹<?php echo e(number_format($totalValue, 0)); ?></div>
                </div>
            ...
            <div
                ...
                <div class="z-10">
                    <h4 class="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-1">
                        Today's Sales</h4>
                    <div class="text-2xl font-black text-slate-800 dark:text-white truncate">
                        ₹<?php echo e(number_format($todaySales, 0)); ?></div>
                </div>
            ...
            <div
                ...
                <div class="z-10">
                    <h4 class="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-1">
                        Today's Value In</h4>
                    <div class="text-2xl font-black text-slate-800 dark:text-white truncate">
                        ₹<?php echo e(number_format($todayPurchases, 0)); ?></div>
                </div>
            ...
            <div
                ...
                <div class="z-10">
                    <h4 class="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-1">
                        Receivables / Dues</h4>
                    <div class="text-2xl font-black text-slate-800 dark:text-white truncate">
                        ₹<?php echo e(number_format($receivables ?? 0, 0)); ?></div>
                </div>
            ...
            <a href="#inventory-section"
                ...
                <div class="z-10">
                    <h4 class="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-1">Low
                        Stock Items</h4>
                    <div class="text-2xl font-black text-slate-800 dark:text-white truncate"><?php echo e($lowStockCount); ?></div>
                </div>
            ...
            <a href="#inventory-section"
                ...
                <div class="z-10">
                    <h4 class="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-1">Near
                        Expiry (< 90 Days)</h4>
                            <div class="text-2xl font-black text-slate-800 dark:text-white truncate"><?php echo e($nearExpiryCount); ?>

                            </div>
                </div>
                <div class="mt-3 flex items-center justify-center text-[10px] font-bold text-orange-500 z-10">
                    <?php echo e($expiredCount); ?> Already Expired
                </div>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1 flex flex-col gap-4">
                <?php if(auth()->user()->hasPermission('inventory.add_stock')): ?>
                ...
                <div class="grid grid-cols-2 gap-4 flex-1">
                    <?php if(auth()->user()->hasPermission('inventory.dispense')): ?>
                    <a href="<?php echo e(route('inventory.dispense')); ?>"
                    ...
                    <?php endif; ?>
                    <?php if(auth()->user()->hasPermission('inventory.transfer')): ?>
                    <a href="<?php echo e(route('inventory.transfer')); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div class="divide-y divide-slate-100 dark:divide-white/5 overflow-y-auto h-52 scrollbar-none">
                    <?php $__empty_1 = true; $__currentLoopData = $topMovers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-bold text-slate-800 dark:text-white text-[11px] truncate w-24">
                                        <?php echo e($item->medicine->name ?? 'Unknown'); ?></div>
                                    <div class="text-[9px] text-slate-400 font-bold uppercase">
                                        <?php echo e($item->medicine->category->name ?? 'N/A'); ?>
                            ...
                            <div class="text-right">
                                <div class="font-black text-slate-800 dark:text-white text-xs">
                                    <?php echo e(number_format($item->total_qty)); ?></div>
                                <div
                                    class="text-[8px] font-bold <?php echo e($item->coverage_days < 7 ? 'text-red-500' : 'text-slate-400'); ?> uppercase">
                                    <?php echo e($item->coverage_days > 90 ? 'Safe' : ($item->coverage_days . ' Days Left')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-darkbg/40 rounded-3xl border border-slate-100 dark:border-white/5 shadow-sm p-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 space-y-2">
                        <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between text-[11px]">
                                <span class="font-bold text-slate-500 capitalize"><?php echo e($method ?: 'Cash'); ?></span>
                                <span class="font-black text-slate-800 dark:text-white">₹<?php echo e(number_format($amount)); ?></span>
                            </div>
            ...
            <div
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('inventory.transactions', ['view' => 'dispenses', 'payment_method' => 'due'])); ?>"
                ...
                <div class="flex-1 overflow-y-auto pr-1 custom-scrollbar" style="max-height: 200px;">
                    <?php $__empty_1 = true; $__currentLoopData = $recentDues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div
                            class="flex justify-between items-center border-b border-white/10 pb-2 mb-2 last:border-0 last:mb-0 last:pb-0 group">
                            <div class="flex flex-col">
                                <span class="font-bold text-sm"><?php echo e($due->patient->full_name ?? 'Unknown'); ?></span>
                                <span class="text-[10px] opacity-70"><?php echo e($due->created_at->diffForHumans()); ?></span>
                            </div>
                            <div class="flex flex-col items-end">
                                <span class="font-black text-lg">₹<?php echo e(number_format($due->final_amount, 0)); ?></span>
                                <a href="<?php echo e(route('patients.show', $due->patient_id)); ?>"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs
                                                    <?php echo e($activity->type === 'in' ? 'bg-blue-100 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' :
                        ($activity->type === 'out' ? 'bg-amber-100 text-amber-600 dark:bg-amber-500/20 dark:text-amber-400' :
                            'bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400')); ?>">
                                            <?php echo e(substr(strtoupper($activity->type), 0, 1)); ?>
                                        ...
                                        <div>
                                            <div class="font-bold text-slate-800 dark:text-white text-sm">
                                                ...
                                                <span class="font-normal text-slate-500">
                                                    <?php echo e($activity->stock->medicine->name ?? 'Item'); ?>
            ...
            <div id="inventory-section"
                ...
                <div class="border-b border-slate-100 dark:border-white/5 shrink-0">
                    ...
                    <div class="p-6 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <?php if($activeFilterCount > 0): ?>
                                <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-accent text-white text-[9px] font-black"><?php echo e($activeFilterCount); ?></span>
                            <?php endif; ?>
                        </div>
                    ...
                    <div id="inventory-filters-panel"
                        ...
                        <div class="px-6 pb-5">
                            <form id="inventory-filter-form" action="<?php echo e(route('inventory.index')); ?>" method="GET"
                                ...
                                <div class="relative w-full md:w-auto">
                                    <select name="status" id="status-filter"
                                        ...
                                        <option value="healthy" <?php echo e(request('status') == 'healthy' ? 'selected' : ''); ?>>Healthy
                                        </option>
                                        <option value="low_stock" <?php echo e(request('status') == 'low_stock' ? 'selected' : ''); ?>>Low Stock
                                        </option>
                                        <option value="near_expiry" <?php echo e(request('status') == 'near_expiry' ? 'selected' : ''); ?>>Near
                                            Expiry</option>
                                ...
                                <div class="relative group w-full md:w-auto flex-1 min-w-[200px]">
                                    <input type="text" name="search" id="inventory-search-input" value="<?php echo e(request('search')); ?>"
                                ...
                                <?php if(auth()->user()->hasPermission('inventory.export')): ?>
                        ...
                        <tbody id="inventory-table-body" class="divide-y divide-slate-100 dark:divide-white/5">
                            <?php $__empty_1 = true; $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="inventory-row hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors"
                                    data-search="<?php echo e(strtolower($stock->medicine?->name . ' ' . $stock->batch_number)); ?>">
                                    <td class="p-4">
                                        <div class="flex flex-col">
                                            <span
                                                class="font-bold text-sm medicine-name"><?php echo e($stock->medicine?->name ?? 'Unknown'); ?></span>
                                            <div class="flex items-center space-x-2 mt-1">
                                                <code
                                                    class="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 rounded text-[9px] batch-number">#<?php echo e($stock->batch_number); ?></code>
                                                <span class="text-slate-200 dark:text-white/10 text-[10px]">•</span>
                                                <span
                                                    class="text-[10px] text-slate-500"><?php echo e($stock->warehouse?->name ?? 'Main'); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex flex-col items-start gap-1">
                                            ...
                                            <?php elseif($stock->expiry_date->diffInMonths(now()) < 3): ?>
                                                <span
                                            ...
                                            <?php endif; ?>
                                            <span
                                                class="text-[9px] text-slate-400 font-bold"><?php echo e($stock->expiry_date->format('M Y')); ?></span>
                                        </div>
                                    </td>
                                    <td class="p-4 text-right">
                                        <span
                                            class="text-sm font-black text-slate-800 dark:text-white"><?php echo e($stock->quantity); ?></span>
                                        <span class="text-[9px] text-slate-400 block"><?php echo e($stock->medicine?->unit); ?></span>
                                    </td>
                                    <td class="p-4 text-right">
                                        <div class="flex items-center justify-end space-x-2">
                                            <?php if(auth()->user()->hasPermission('inventory.adjust')): ?>
                                            <a href="<?php echo e(route('inventory.adjust', $stock->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth()->user()->hasPermission('inventory.transfer')): ?>
                                            <a href="<?php echo e(route('inventory.transfer', ['stock_id' => $stock->id])); ?>"
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        const medicineValueData = <?php echo json_encode($medicineValueChartData, 15, 512) ?>;
        const warehouseData = <?php echo json_encode($warehouseChartData, 15, 512) ?>;
        const trendData = <?php echo json_encode($trendChartData, 15, 512) ?>;
        const expiryData = <?php echo json_encode($expiryBreakdown, 15, 512) ?>;
        const categoryQtyData = <?php echo json_encode($categoryQtyChartData, 15, 512) ?>;
        const paymentData = <?php echo json_encode($paymentMethods, 15, 512) ?>;
        const sponsorData = <?php echo json_encode($sponsorChartData, 15, 512) ?>;
        ...
        function downloadBatchCSV() {
            ...
            const url = "<?php echo e(route('inventory.export-batch')); ?>" + (params.toString() ? '?' + params.toString() : '');
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (toggleBtn && panel) {
                ...
                const hasActiveFilters = <?php echo e($activeFilterCount > 0 ? 'true' : 'false'); ?>;
                if (hasActiveFilters) {
                    openFilters();
                }
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/inventory/index.blade.php ENDPATH**/ ?>