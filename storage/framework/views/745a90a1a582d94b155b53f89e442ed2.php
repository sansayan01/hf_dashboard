...
<?php $__env->startSection('header_title', 'Farmasi & Stock'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <?php if($patient->creator ?? null): ?>
                        <div class="flex items-center gap-2 mt-2 text-xs text-slate-400">
                            ...
                            <span class="font-bold text-accent"><?php echo e($patient->creator->profile->full_name ?? 'N/A'); ?></span>
                            <span
                                class="bg-slate-100 dark:bg-white/10 px-1.5 py-0.5 rounded text-[10px] font-mono"><?php echo e($patient->creator->employee_id ?? 'N/A'); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div
            ...
            <form id="dispenseForm" action="<?php echo e(route('medicine.distribute.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <?php echo e(Auth::user()->profile->full_name ?? Auth::user()->employee_id); ?>
    ...
    <script>
        ...
        searchInput.addEventListener('input', function (e) {
            ...
            debounceTimer = setTimeout(() => {
                fetch(`<?php echo e(route('medicine.search')); ?>?q=${encodeURIComponent(query)}&camp_id=${selectedCamp}`)
                    .then(res => res.json())
                    .then(data => {
        ...
        // Also update QR when amount paid is manually changed
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\medicine\distribute.blade.php ENDPATH**/ ?>