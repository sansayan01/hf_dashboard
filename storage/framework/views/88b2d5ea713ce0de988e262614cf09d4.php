...
?>
<ul class="space-y-1">
    <?php if($effectiveUser->hasPermission('dashboard.view')): ?>
        <li>
    ...
    <?php endif; ?>
    <?php if($effectiveUser->hasPermission('survey.view')): ?>
        <li>
    ...
    <?php endif; ?>
    <?php if($effectiveUser->hasPermission('patients.view')): ?>
        <li>
    ...
    <?php endif; ?>
    <?php if($effectiveUser->hasPermission('appointments.view')): ?>
        <li>
    ...
    <?php if($effectiveUser->hasPermission('attendance.view')): ?>
        <li>
    ...
    <?php endif; ?>
    <?php if($effectiveUser->hasPermission('membership.view')): ?>
        <li>
    ...
    <?php endif; ?>
    <?php if($effectiveUser->hasPermission('inventory.view')): ?>
        <li>
    ...
    <?php if($effectiveUser->hasPermission('team.view')): ?>
        <li>
        ...
        <?php if($effectiveUser->hasPermission('staffs.view')): ?>
            <li>
        ...
        <?php if($effectiveUser->hasPermission('bin.view')): ?>
            <li>
    ...
    <?php if($effectiveUser->hasPermission('finances.view')): ?>
        <li>
    ...
    <?php if($effectiveUser->hasPermission('admin.view')): ?>
        <li>
            <a href="<?php echo e(route('admin.control-panel')); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg text-bodydark hover:text-white hover:bg-secondary transition font-medium <?php echo e(request()->routeIs('admin.control-panel') ? 'bg-accent text-white shadow-lg' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li>
        <a href="<?php echo e(route('profile.edit')); ?>"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg text-bodydark hover:text-white hover:bg-secondary transition font-medium <?php echo e(request()->routeIs('profile.*') ? 'bg-accent text-white shadow-lg' : ''); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
