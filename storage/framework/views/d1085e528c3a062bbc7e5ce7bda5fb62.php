...
<?php $__env->startSection('title', 'Edit Distribution'); ?>
<?php $__env->startSection('header_title', 'Edit Medicine Distribution'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div
            ...
            <div class="relative z-10 flex items-start gap-6">
                <div
                    ...
                    <?php echo e(substr($distribution->patient->full_name ?? 'N', 0, 1)); ?>
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-black text-slate-800 dark:text-white leading-none mb-2">
                        <?php echo e($distribution->patient->full_name ?? 'Unknown Patient'); ?>

                    </h2>
                    <div class="flex flex-wrap items-center gap-3 text-sm font-bold text-slate-500">
                        <span
                            class="bg-slate-100 dark:bg-white/5 px-2 py-0.5 rounded"><?php echo e($distribution->patient->patient_id ?? 'N/A'); ?></span>
                        <span>•</span>
                        <span>Invoice #<?php echo e($distribution->id); ?></span>
                        <span>•</span>
                        <span><?php echo e($distribution->created_at->format('M d, Y h:i A')); ?></span>
                    </div>
                    <?php if($distribution->patient->creator ?? null): ?>
                        <div class="flex items-center gap-2 mt-2 text-xs text-slate-400">
                            ...
                            <span
                                class="font-bold text-accent"><?php echo e($distribution->patient->creator->profile->full_name ?? 'N/A'); ?></span>
                            <span
                                class="bg-slate-100 dark:bg-white/10 px-1.5 py-0.5 rounded text-[10px] font-mono"><?php echo e($distribution->patient->creator->employee_id ?? 'N/A'); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div
            ...
            <form id="editForm" action="<?php echo e(route('medicine.distribution.update', $distribution->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <?php echo e($distribution->camp->name ?? 'N/A'); ?> (<?php echo e($distribution->camp->location ?? 'No Loc'); ?>)
                        </div>
                        <input type="hidden" id="camp_id" value="<?php echo e($distribution->camp_id); ?>">
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <?php echo e($distribution->pharmacist->profile->full_name ?? $distribution->pharmacist->employee_id ?? 'N/A'); ?>
                            ...
                            <tr>
                                <td colspan="5"
                                    ...
                                    Discount (<input type="number" step="0.01" name="discount_percentage"
                                        ...
                                        value="<?php echo e($distribution->discount_percentage); ?>"
                                        oninput="isManualDiscount = true; renderCart();">%)
                                </td>
    ...
    <script>
        ...
        <?php $__currentLoopData = $distribution->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            addedItems[<?php echo e($item->medicine_id); ?>] = {
                id: <?php echo e($item->medicine_id); ?>,
                itemId: <?php echo e($item->id); ?>, // Distribution item ID for updates
                name: <?php echo json_encode($item->medicine->name ?? 'Unknown', 15, 512) ?>,
                genericName: <?php echo json_encode($item->medicine->generic_name ?? '', 15, 512) ?>,
                price: <?php echo e($item->unit_price); ?>,
                stock: <?php echo e($item->quantity + ($stocks[$item->medicine_id] ?? 0)); ?>, // Original qty + current stock
                qty: <?php echo e($item->quantity); ?>,
                isExisting: true
            };
            existingItemIds[<?php echo e($item->medicine_id); ?>] = <?php echo e($item->id); ?>;
        ...
        searchInput.addEventListener('input', function (e) {
            ...
            debounceTimer = setTimeout(() => {
                fetch(`<?php echo e(route('medicine.search')); ?>?q=${encodeURIComponent(query)}&camp_id=${campId}`)
                    .then(res => res.json())
                    .then(data => {
            ...
            Object.values(addedItems).forEach((item, index) => {
                ...
                tr.innerHTML = `
                                    ...
                                    <td class="py-4 text-center">
                                        <input type="number" id="qty-input-${item.id}" name="items[${index}][quantity]" value="${item.qty}" min="1" max="${item.stock}"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\medicine\edit.blade.php ENDPATH**/ ?>