...
<?php $__env->startSection('header_title', 'Edit Appointment'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
            ...
            <form action="<?php echo e(route('patients.appointments.update', $appointment->id)); ?>" method="POST"
                class="p-8 space-y-8">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select name="doctor_type" id="doctor_type" onchange="handleSpecialistSelection(this.value)"
                                    ...
                                    <?php $__currentLoopData = $standardSpecialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type); ?>" <?php echo e($selectedType == $type ? 'selected' : ''); ?>>
                                            <?php echo e($type); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <option value="Any other" <?php echo e($selectedType == 'Any other' ? 'selected' : ''); ?>>Any
                                        other</option>
                                </select>
                                <div
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="specialist-other-container"
                            class="space-y-2 <?php echo e($selectedType == 'Any other' ? '' : 'hidden'); ?>">
                            ...
                            <input type="text" id="specialist-other-input" name="doctor_type_other"
                                value="<?php echo e(old('doctor_type_other', $otherText)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="location" id="location"
                            value="<?php echo e(old('location', $appointment->location)); ?>"
                    ...
                    <div class="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input type="date" name="appointment_date"
                                value="<?php echo e(old('appointment_date', $appointment->appointment_date->format('Y-m-d'))); ?>"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="time" name="appointment_time"
                                value="<?php echo e(old('appointment_time', \Carbon\Carbon::parse($appointment->appointment_time)->format('H:i'))); ?>"
                                class="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:border-accent focus:ring-0 transition-colors font-bold text-slate-700">
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\appointments\edit.blade.php ENDPATH**/ ?>