...
<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto pb-12">
        ...
        <div
            ...
            <form action="<?php echo e(route('camp_records.store')); ?>" method="POST" class="space-y-12">
                <?php echo csrf_field(); ?>
                    ...
                    <div
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="camp_name" value="<?php echo e(old('camp_name')); ?>" required
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 font-medium"><?php echo e($message); ?></span>
                            <?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 font-medium"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        </div>
                        ...
                        <div class="space-y-1.5 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="rm" value="<?php echo e(old('rm')); ?>"
                                    class="w-full h-12 pl-12 pr-4 rounded-xl border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 text-sm focus:border-accent focus:ring-accent/20 outline-none transition-all shadow-sm dark:text-white"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="doctor_name" value="<?php echo e(old('doctor_name')); ?>"
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="pathologist" value="<?php echo e(old('pathologist')); ?>"
                                    class="w-full h-12 pl-12 pr-4 rounded-xl border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm focus:border-emerald-500 focus:ring-emerald-500/20 outline-none transition-all shadow-sm dark:text-white"
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="pharmacists_name" value="<?php echo e(old('pharmacists_name')); ?>"
                                    class="w-full h-12 pl-12 pr-4 rounded-xl border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm focus:border-emerald-500 focus:ring-emerald-500/20 outline-none transition-all shadow-sm dark:text-white"
                    ...
                    <div
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" name="patients_count" value="<?php echo e(old('patients_count', 0)); ?>" min="0"
                                    step="1"
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                <div
                                    ...
                                    ₹</div>
                                <input type="number" name="medicine_mrp" value="<?php echo e(old('medicine_mrp', 0)); ?>" min="0"
                                    step="0.01"
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                <div
                                    class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 font-bold group-focus-within:text-amber-500 transition-colors">
                                    ₹</div>
                                <input type="number" name="medicine_discount" value="<?php echo e(old('medicine_discount', 0)); ?>"
                                    min="0" step="0.01"
                        ...
                        <div class="space-y-1.5 focus-within:-translate-y-1 transition-transform duration-300">
                            ...
                            <div class="relative group">
                                <div
                                    class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 font-bold group-focus-within:text-amber-500 transition-colors">
                                    ₹</div>
                                <input type="number" name="billing_price" value="<?php echo e(old('billing_price', 0)); ?>" min="0"
                                    step="0.01"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <div
                                        ...
                                        ₹</div>
                                    <input type="number" id="profit" name="profit" value="<?php echo e(old('profit', 0)); ?>"
                                        step="0.01"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <div
                                        ...
                                        ₹</div>
                                    <input type="number" id="expenses" name="expenses" value="<?php echo e(old('expenses', 0)); ?>"
                                        min="0" step="0.01"
                            ...
                            <div class="space-y-2 lg:border-l lg:border-slate-100 dark:lg:border-white/5 lg:pl-8">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="net_profit_loss" name="net_profit_loss"
                                        value="<?php echo e(old('net_profit_loss', 0)); ?>" step="0.01" readonly
