                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-8">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="inline-flex items-center gap-3 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl mb-6">
                            ...
                            <span class="text-white font-black tracking-widest text-sm uppercase"><?php echo e($patient->patient_id ?? $patient->survey_id); ?></span>
                        </div>

                        <div class="flex flex-wrap gap-3">
                            <button type="button" onclick="openHistoryModal()"
                                class="btn-action px-5 py-2.5 bg-indigo-600 text-white font-bold rounded-xl text-xs hover:bg-indigo-500 shadow-lg shadow-indigo-600/20">Medicine
                                History</button>
                            ...
                            <?php if(auth()->user()->id === $patient->created_by || auth()->user()->canAccess($patient->creator)): ?>
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <form id="delete-patient-form" action="<?php echo e(route('patients.destroy', $patient->id)); ?>" method="POST" class="hidden">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                    </form>
                                    <button type="button" onclick="confirmDelete()"
                                        class="btn-action px-5 py-2.5 bg-rose-500 text-white font-bold rounded-xl text-xs hover:bg-rose-400 shadow-lg shadow-rose-500/20 flex items-center gap-2">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 font-bold uppercase tracking-widest">
                                <?php echo e($patient->full_name); ?> (<?php echo e($patient->patient_id ?? $patient->survey_id); ?>)</p>
                        </div>
                    </div>
