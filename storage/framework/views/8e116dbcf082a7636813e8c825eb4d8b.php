...
<?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
        ...
        <?php if($effectiveUser->hasPermission('team.toggle_salary_mode')): ?>
            <td class="px-6 py-4">
        ...
        <td class="px-6 py-4 text-right">
            <div class="flex items-center justify-end space-x-2">
                <?php if($u->status === 'pending' && $effectiveUser->hasPermission('team.approve_users') && $effectiveUser->canApprove($u)): ?>
                ...
                <?php endif; ?>
                <?php if($effectiveUser->hasPermission('team.view_profile')): ?>
                ...
                <?php endif; ?>
                <?php if($effectiveUser->canAccess($u) && $effectiveUser->hasPermission('team.generate_offer_letter')): ?>
                ...
                <?php endif; ?>
                <?php if($effectiveUser->hasPermission('team.generate_id_card')): ?>
                ...
                <?php endif; ?>
                <?php if($effectiveUser->hasPermission('team.delete_users') && $u->employee_id !== 'HFSA000001'): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/users/partials/table.blade.php ENDPATH**/ ?>