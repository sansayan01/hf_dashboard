                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <div class="flex items-center space-x-2 mb-1">
                                    ...
                                    <span
                                        class="text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-100/50 dark:bg-white/5 px-2 py-0.5 rounded"><?php echo e($appointment->appointment_id); ?></span>
