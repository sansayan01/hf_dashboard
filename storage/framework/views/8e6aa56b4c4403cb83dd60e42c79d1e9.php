...
<body class="min-h-screen flex items-center justify-center p-6">
    <div class="max-w-2xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100">
        <div class="p-8 sm:p-12">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-slate-500 font-medium">Please stay on this page while we process <?php echo e(count($users)); ?>
    ...
    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <template id="user-<?php echo e($user->id); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\HF\resources\views\users\bulk_offer_zip.blade.php ENDPATH**/ ?>