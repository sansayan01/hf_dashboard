...
<?php $__env->startSection('header_title', 'Edit Income'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-2xl mx-auto pb-12">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h2 class="text-lg font-bold text-slate-900 dark:text-white">Edit Income</h2>
                <p class="text-xs text-slate-400 font-medium"><?php echo e($income->title); ?></p>
            </div>
        </div>

        
        <div class="form-card">
            <form action="<?php echo e(route('incomes.update', $income)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="amount" value="<?php echo e(old('amount', $income->amount)); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = \App\Models\Income::CATEGORIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cat); ?>" <?php echo e(old('category', $income->category) == $cat ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="income_date"
                                value="<?php echo e(old('income_date', $income->income_date->format('Y-m-d'))); ?>" required
                                max="<?php echo e(date('Y-m-d')); ?>" class="field-input <?php $__errorArgs = ['income_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> has-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = \App\Models\Income::PAYMENT_METHODS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('payment_method', $income->payment_method) == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="reference_number"
                                value="<?php echo e(old('reference_number', $income->reference_number)); ?>"
                                placeholder="UPI / Cheque / Transaction ref" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">Received By <span class="req">*</span></label>
                            <input type="text" name="received_by" value="<?php echo e(old('received_by', $income->received_by)); ?>"
                                required list="received-by-list" placeholder="Type or select a name..."
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="source" value="<?php echo e(old('source', $income->source)); ?>"
                                placeholder="Who or where did the funds come from?"
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <textarea name="description" rows="2" placeholder="Brief description..."
                                class="field-input resize-none"><?php echo e(old('description', $income->description)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <?php if($income->receipt_path): ?>
                                <div class="receipt-badge">
                                    ...
                                    <a href="<?php echo e(url('/storage-render/' . $income->receipt_path)); ?>" target="_blank"
                                        class="ml-auto text-xs font-bold text-emerald-600 hover:text-emerald-800 dark:text-emerald-400">View
                                        →</a>
                                </div>
                            <?php endif; ?>
                            ...
                            <label for="receipt-input" class="dropzone">
                                ...
                                <span id="receipt-label" class="text-sm font-medium text-slate-500 dark:text-slate-400">
                                    <?php echo e($income->receipt_path ? 'Replace receipt' : 'Upload receipt'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2" placeholder="Any additional notes..."
                                class="field-input resize-none"><?php echo e(old('notes', $income->notes)); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\incomes\edit.blade.php ENDPATH**/ ?>