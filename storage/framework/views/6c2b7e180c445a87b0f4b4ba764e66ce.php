...
<?php $__env->startSection('title', 'Manual Stock Adjustment'); ?>
<?php $__env->startSection('header_title', 'NGO Pharmacy | Adjust Stock'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-2xl mx-auto">
        <div
            ...
            <form action="<?php echo e(route('inventory.process-adjust', $stock->id)); ?>" method="POST" class="p-8 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div
                    ...
                    <div>
                        ...
                        <span class="text-sm font-bold"><?php echo e($stock->medicine->name); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Batch
                            Number</span>
                        <code
                            class="text-xs px-2 py-1 bg-white dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-white/5 font-bold">#<?php echo e($stock->batch_number); ?></code>
                    </div>
                    <div>
                        <span
                            class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Warehouse</span>
                        <span class="text-xs font-bold"><?php echo e($stock->warehouse->name); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Current
                            Stock</span>
                        <span class="text-sm font-black text-accent"><?php echo e($stock->quantity); ?>

                            <?php echo e($stock->medicine->unit); ?>s</span>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="new_quantity" value="<?php echo e($stock->quantity); ?>" required min="0"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\inventory\adjust.blade.php ENDPATH**/ ?>