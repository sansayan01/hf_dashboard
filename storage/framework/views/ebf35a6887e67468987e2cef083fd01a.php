...
<body>
    <div class="card-container">
        ...
        <?php if($qrBase64): ?>
            <img src="<?php echo e($qrBase64); ?>" class="qr-code" alt="Verify Member">
        <?php endif; ?>
        ...
        <div class="detail-block col-2 row-1" style="width: 144pt;">
            ...
            <div class="val-address" style="font-size: <?php echo e($addrFontSize); ?>;">
        ...
        <div class="footer-text">
            <span style="display:inline-block; margin-right: 1pt;">
                <img src="<?php echo e($iconPhone); ?>" style="width: 4.5pt; height: 4.5pt; transform: translateY(0.5pt);">
            </span> +91 9339677678 &nbsp;&nbsp;|&nbsp;&nbsp;

            <span style="display:inline-block; margin-right: 1pt;">
                <img src="<?php echo e($iconMail); ?>" style="width: 4.5pt; height: 4.5pt; transform: translateY(0.5pt);">
            </span> info@hfburdwan.in &nbsp;&nbsp;|&nbsp;&nbsp;

            <span style="display:inline-block; margin-right: 1pt;">
                <img src="<?php echo e($iconWeb); ?>" style="width: 4.5pt; height: 4.5pt; transform: translateY(0.5pt);">
            </span> www.hfburdwan.in<br>

            <span style="color: #ffffff; font-weight: bold; display:inline-block; margin-right: 1pt; padding-top: 1pt;">
                <img src="<?php echo e($iconHq); ?>" style="width: 4.5pt; height: 4.5pt; transform: translateY(0.5pt);">
