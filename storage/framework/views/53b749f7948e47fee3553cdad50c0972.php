        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-7">
            ...
            <div class="card p-5">
                ...
                <div class="stat-value" style="font-size:18px" id="topCategoryStat">
                    <?php echo e($topCategory ? $topCategory->category : 'N/A'); ?></div>
                <div class="text-[11px] text-slate-400 font-medium mt-1">
                    <?php echo e($topCategory ? '₹' . number_format($topCategory->total, 2) : '—'); ?></div>
            </div>
        </div>
