    ...
    <div
        ...
        <div
            ...
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    <span
                        ...
                        <span id="stat-total"><?php echo e($surveys->total()); ?></span> Total
                    </span>
                </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('survey.view_nia')): ?>
                    ...
                    <input type="hidden" name="show_nia" value="<?php echo e(request('show_nia', 0)); ?>" form="filterForm">
                <?php endif; ?>
                ...
                <?php if(auth()->user()->hasPermission('survey.create')): ?>
        ...
        <?php else: ?>
            <!-- Bulk Actions Bar -->
            <?php if(auth()->user()->hasPermission('survey.bulk_delete')): ?>
