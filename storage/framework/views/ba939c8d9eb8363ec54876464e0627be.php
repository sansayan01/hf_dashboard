...
<body class="bg-gray-100 p-8">
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <p class="text-gray-600 mb-4">Total Users: <span class="font-bold"><?php echo e(count($users)); ?></span></p>
        ...
        <div id="cards-container" style="position: absolute; left: -9999px; top: 0;">
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="id-card" id="card-<?php echo e($user->id); ?>" data-filename="ID_Card_<?php echo e($user->employee_id); ?>.png">
                    <div class="header-curve">
                        <img src="<?php echo e(asset('img/hf_gold_logo.png')); ?>" alt="Logo" class="logo-img"
                    ...
                    <div class="details">
                        ...
                        <h2 class="text-red-600 uppercase leading-none mb-1"
                            style="font-weight: 900; font-size: <?php echo e($c_nameFontSize); ?>; white-space: nowrap;"><?php echo e($c_name); ?>
...
</html><?php /**PATH C:\xampp\htdocs\HF\resources\views\users\bulk_id_cards.blade.php ENDPATH**/ ?>