<?php if(count($pendingUsers) > 0): ?>
    <div
        ...
        <div
            ...
            <a href="<?php echo e(route('users.index', ['status' => 'pending'])); ?>"
                class="text-[10px] font-black text-rose-500 hover:underline uppercase tracking-widest">View All</a>
        </div>
        <div class="p-0">
            <div class="divide-y divide-slate-100 dark:divide-white/5">
                <?php $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="flex items-center space-x-4">
                            <div
                                ...
                                <?php if($p->profile?->profile_picture): ?>
                                    <img src="<?php echo e($p->profile->getProfilePictureUrl()); ?>"
                                        class="w-full h-full rounded-full object-cover">
                                <?php else: ?>
                                    <?php echo e(substr($p->profile?->full_name ?? $p->employee_id, 0, 1)); ?>

                                <?php endif; ?>
                            </div>
                            <div>
                                <p class="text-sm font-black text-slate-800 dark:text-white leading-none mb-1">
                                    <?php echo e($p->profile?->full_name ?? 'Incomplete'); ?></p>
                                <p class="text-[10px] text-slate-400 font-bold uppercase"><?php echo e($p->employee_id); ?> •
                                    <?php echo e($p->getDesignationLabel()); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <form action="<?php echo e(route('users.approve', $p->id)); ?>" method="POST" class="no-loader">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                            ...
                            <a href="<?php echo e(route('users.show', $p->id)); ?>"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/dashboard/partials/pending_approvals.blade.php ENDPATH**/ ?>