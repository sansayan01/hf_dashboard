        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div class="flex justify-center mb-8">
                <div class="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-lg p-2">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" class="w-full h-full object-contain" alt="Logo">
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\HF\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>