        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="info-card scroll-reveal bg-white rounded-3xl p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $user->activityLogs()->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
