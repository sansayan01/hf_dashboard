                ...
                <div class="flex flex-col lg:flex-row lg:items-start gap-6">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(auth()->user()->hasPermission('dashboard.view_as') && auth()->user()->canAccess($user) && auth()->user()->id !== $user->id): ?>
                            ...
                            <?php if(in_array(auth()->user()->employee_id, ['HFSA000001', 'HFSA000002']) && auth()->user()->id !== $user->id): ?>
                                <a href="<?php echo e(route('users.permissions', $user->id)); ?>"
                                    class="btn-action inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-bold rounded-xl text-xs shadow-lg shadow-blue-600/30 hover:from-cyan-500 hover:to-blue-500">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
