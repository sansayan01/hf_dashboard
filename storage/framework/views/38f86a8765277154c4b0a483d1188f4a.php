...
<?php $__env->startSection('header_title', 'Member Profile'); ?>
    ...
    <div class="max-w-5xl mx-auto space-y-6 pb-12">
        ...
        <div class="rounded-3xl shadow-2xl overflow-hidden scroll-reveal"
            ...
            <div class="absolute right-0 top-0 select-none pointer-events-none opacity-[0.04] hidden lg:block">
                <span class="text-[15rem] font-black text-white uppercase tracking-tighter leading-none">
                    <?php echo e(substr($user->profile?->full_name ?? $user->employee_id, 0, 2)); ?>
            ...
            <div class="relative p-8">
                        ...
                        <div class="profile-avatar-ring w-28 h-28">
                            <div
                                ...
                                <?php if($user->profile?->profile_picture): ?>
                                    <img src="<?php echo e($user->profile->getProfilePictureUrl()); ?>"
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-start gap-3 mb-2">
                            <h2 class="text-4xl font-black text-white tracking-tight leading-none">
                                <?php echo e($user->profile?->full_name ?? 'Incomplete Profile'); ?>
                            ...
                            <?php if($user->is_office_in_charge && $user->designation !== 'office_in_charge'): ?>
                                <span
                        ...
                        <div
                            ...
                            <span class="text-white font-black tracking-widest text-sm"><?php echo e($user->employee_id); ?></span>
                        </div>

                        
                        <div class="flex flex-wrap gap-2">
                            <?php if((auth()->user()->isSuperAdmin() || auth()->user()->hasFinancePermission('view')) && auth()->user()->canAccess($user) && auth()->user()->id !== $user->id): ?>
                                <a href="<?php echo e(route('dashboard', ['as_user' => $user->id])); ?>"
                            ...
                            <?php if(in_array(auth()->user()->employee_id, ['HFSA000001', 'HFSA000002']) && str_starts_with($user->employee_id, 'HFSA') && auth()->user()->id !== $user->id): ?>
                                    ...
                                    <div id="financeDropdown"
                                        ...
                                        <div class="py-1">
                                            <button onclick="updateFinancePermission('none')"
                                                class="w-full text-left block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 <?php echo e($user->finance_permission == null ? 'font-bold bg-gray-50' : ''); ?>">
                                                None <?php if($user->finance_permission == null): ?> ✓ <?php endif; ?>
                                            </button>
                                            <button onclick="updateFinancePermission('view')"
                                                class="w-full text-left block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 <?php echo e($user->finance_permission == 'view' ? 'font-bold bg-gray-50' : ''); ?>">
                                                Can view only <?php if($user->finance_permission == 'view'): ?> ✓ <?php endif; ?>
                                            </button>
                                            <button onclick="updateFinancePermission('edit')"
                                                class="w-full text-left block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 <?php echo e($user->finance_permission == 'edit' ? 'font-bold bg-gray-50' : ''); ?>">
                                                Can view & edit <?php if($user->finance_permission == 'edit'): ?> ✓ <?php endif; ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if(auth()->user()->isSuperAdmin()): ?>
                                <div class="relative">
                                    ...
                                    <div id="id-card-dropdown"
                                        ...
                                        <a href="<?php echo e(route('users.id-card', ['user' => $user->id, 'format' => 'png'])); ?>"
                                            target="_blank"
                                        ...
                                        <a href="<?php echo e(route('users.id-card', ['user' => $user->id, 'format' => 'pdf'])); ?>"
                                            target="_blank"
                                            class="flex items-center gap-3 px-4 py-3 text-sm font-bold text-slate-700 hover:bg-violet-50 hover:text-violet-600 transition rounded-xl">
                                        ...
                                        <a href="<?php echo e(route('users.id-card', ['user' => $user->id, 'format' => 'jpg'])); ?>"
                                            target="_blank"
                                            class="flex items-center gap-3 px-4 py-3 text-sm font-bold text-slate-700 hover:bg-violet-50 hover:text-violet-600 transition rounded-xl">
                            ...
                            <?php if(auth()->user()->canAccess($user)): ?>
                                <a href="<?php echo e(route('users.joining-letter', $user->id)); ?>" target="_blank"
                            ...
                            <?php if($user->isRO() && (auth()->user()->isSuperAdmin() || \App\Models\RolePermission::check(auth()->user()->designation, 'can_assign_oic'))): ?>
                                <form action="<?php echo e(route('users.toggle-oic', $user->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="btn-action inline-flex items-center gap-2 px-5 py-2.5 font-bold rounded-xl text-xs shadow-lg transition
                                                                                                                <?php echo e($user->is_office_in_charge ? 'bg-orange-50 text-orange-600 border border-orange-200 hover:bg-orange-100' : 'bg-amber-600 text-white shadow-amber-600/30 hover:bg-amber-500'); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                        </svg>
                                        <?php echo e($user->is_office_in_charge ? 'Remove OIC' : 'Assign OIC'); ?>

                                    </button>
                                </form>
                            <?php endif; ?>

                            <?php if($currentUser->canEdit($user)): ?>
                            ...
                            <?php if($user->status === 'pending' && auth()->user()->canApprove($user)): ?>
                            ...
                            <?php if(auth()->user()->isSuperAdmin() && auth()->user()->id !== $user->id && $user->employee_id !== 'HFSA000001'): ?>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-8 pt-6 border-t border-white/10">
                    <div class="hero-stat-card rounded-2xl p-4 cursor-default">
                        ...
                        <?php if((auth()->user()->isSuperAdmin() || auth()->user()->isOfficeInCharge()) && $uplineUser): ?>
                            <a href="<?php echo e(route('users.show', $uplineUser->id)); ?>"
                                class="flex items-center gap-1 text-sm font-black text-accent hover:text-white transition-colors group">
                                <span class="truncate"><?php echo e($uplineName); ?></span>
                        ...
                        <?php else: ?>
                            <p class="text-sm font-black text-white truncate"><?php echo e($uplineName); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="hero-stat-card rounded-2xl p-4 cursor-default">
                        <p class="text-[9px] font-black text-white/50 uppercase tracking-[0.2em] mb-2">Direct Downline</p>
                        <p class="text-sm font-black text-white">
                            <span class="text-xl" style="color:#3C50E0"><?php echo e($user->children->count()); ?></span>&nbsp;Members
                        </p>
                    </div>
                    <div class="hero-stat-card rounded-2xl p-4 cursor-default">
                        <p class="text-[9px] font-black text-white/50 uppercase tracking-[0.2em] mb-2">Date Joined</p>
                        <p class="text-sm font-black text-white"><?php echo e($user->created_at->format('d M, Y')); ?></p>
                    </div>
                    <div class="hero-stat-card rounded-2xl p-4 cursor-default">
                        <p class="text-[9px] font-black text-white/50 uppercase tracking-[0.2em] mb-2">Contact No.</p>
                        <p class="text-sm font-black text-white"><?php echo e($user->profile?->phone_number ?? 'N/A'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="data-field space-y-1.5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="font-bold text-slate-800 truncate"><?php echo e($user->email); ?></p>
                            </div>
                        </div>
                        <div class="data-field space-y-1.5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="font-bold text-slate-800"><?php echo e($user->profile?->blood_group ?? 'Not Specified'); ?>
                        ...
                        <div class="data-field space-y-1.5">
                            ...
                            <p class="font-bold text-slate-800 font-mono tracking-wider">
                                <?php echo e($user->profile?->aadhaar_number ?? 'N/A'); ?>
                        ...
                        <div class="data-field space-y-1.5">
                            ...
                            <p class="font-bold text-slate-800 uppercase font-mono tracking-wider">
                                <?php echo e($user->profile?->pan_number ?? 'N/A'); ?>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div
                                ...
                                <p class="font-bold text-slate-800 leading-relaxed"><?php echo e($user->profile?->address ?? 'N/A'); ?>
                                ...
                                <p class="text-xs text-slate-500 mt-2 flex items-center gap-1.5">
                                    ...
                                    <span><?php echo e(collect([$user->profile?->gram_panchayat, $user->profile?->block, $user->profile?->district, $user->profile?->state])->filter()->join(', ')); ?><?php echo e($user->profile?->pin_code ? ' - ' . $user->profile->pin_code : ''); ?></span>
                                </p>
                            </div>
                        </div>
                ...
                <?php if(auth()->user()->hasFinancePermission('view')): ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="info-card scroll-reveal bg-white rounded-3xl p-6">
                            ...
                            <div class="space-y-3">
                                <div
                                    ...
                                    <span
                                        class="font-bold text-slate-700 text-sm"><?php echo e($user->bankDetails?->bank_name ?? 'N/A'); ?></span>
                                </div>
                                <div
                                    class="flex items-center justify-between p-3 bg-slate-50 rounded-xl hover:bg-emerald-50 transition-colors border border-transparent hover:border-emerald-100">
                                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">A/C No.</span>
                                    <div class="flex items-center gap-2">
                                        <span class="font-black text-slate-700 text-sm font-mono tracking-widest" id="account-number-text">••••<?php echo e(substr($user->bankDetails?->account_number ?? '0000', -4)); ?></span>
                                        <?php if($user->bankDetails?->account_number): ?>
                                ...
                                <div
                                    ...
                                    <span
                                        class="font-bold text-slate-700 text-sm font-mono uppercase"><?php echo e($user->bankDetails?->ifsc_code ?? 'N/A'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-card scroll-reveal rounded-3xl overflow-hidden">
                            <div class="donation-card p-6 h-full">
                                ...
                                <div class="relative mb-4">
                                    ...
                                    <p class="text-5xl font-black text-white">₹<?php echo e(number_format($user->joining_donation, 0)); ?>
                                    ...
                                    <?php if($user->payment_reference): ?>
                                        <div
                                            ...
                                            <span class="text-[9px] font-black text-white/50 uppercase tracking-widest">Ref
                                                ID</span>
                                            <span
                                                class="text-xs font-bold text-white font-mono"><?php echo e($user->payment_reference); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($user->payment_screenshot): ?>
                                        <a href="<?php echo e(route('storage.bridge', ['path' => $user->payment_screenshot])); ?>"
                                            target="_blank"
            ...
            <div class="space-y-6">
                    ...
                    <div class="scroll-reveal relative rounded-3xl p-6 mb-6"
                        ...
                        <h3 class="relative font-black text-white text-lg mb-4 flex items-center justify-between">
                            <span class="flex items-center gap-2">
                                ...
                                <?php echo e($attendanceSummary['month_name']); ?> Attendance
                            </span>
                            <div class="flex items-center gap-2">
                                <?php
                                ...
                                <a href="<?php echo e(route('attendance.show', $user->id)); ?>"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-white/10 rounded-2xl p-4 border border-white/10 hover:bg-white/15 transition">
                                ...
                                <p class="text-2xl font-black text-white"><?php echo e($attendanceSummary['present']); ?> <span
                            ...
                            <div class="bg-white/10 rounded-2xl p-4 border border-white/10 hover:bg-white/15 transition">
                                ...
                                <p class="text-2xl font-black text-white">
                                    ₹<?php echo e(number_format($attendanceSummary['total_amount'])); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="scroll-reveal relative rounded-3xl p-6"
                    ...
                    <div class="relative grid grid-cols-2 gap-3 mb-4">
                        <div class="rounded-2xl p-4 text-center transition-all duration-300 hover:scale-105 cursor-default"
                            ...
                            <p class="text-3xl font-black text-white mb-1"><?php echo e($directCount); ?></p>
                        ...
                        <div class="rounded-2xl p-4 text-center transition-all duration-300 hover:scale-105 cursor-default"
                            ...
                            <p class="text-3xl font-black mb-1" style="color:#3C50E0;"><?php echo e($totalCount); ?></p>
                            <p class="text-[9px] font-black uppercase tracking-widest" style="color:rgba(255,255,255,0.4);">
                                Total</p>
                        </div>
                    </div>
                    <?php if($totalCount > 0): ?>
                        <div class="relative h-2 rounded-full overflow-hidden" style="background:rgba(255,255,255,0.1);">
                            <div class="h-full rounded-full transition-all duration-1000"
                                style="width: <?php echo e($directCount > 0 ? min(100, ($directCount / max($totalCount, 1)) * 100) : 0); ?>%; background: linear-gradient(90deg, #3C50E0, #8b5cf6);">
                            </div>
                        </div>
                ...
                <?php if($user->status === 'pending' && (auth()->user()->isSuperAdmin() || auth()->user()->id === $user->parent_id)): ?>
                    <div class="info-card scroll-reveal bg-white rounded-3xl p-6 border-2 border-dashed border-indigo-100">
                        ...
                        <?php if($user->offer_letter_signed): ?>
                            <div class="p-4 bg-emerald-50 rounded-2xl border border-emerald-100 mb-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(route('storage.bridge', ['path' => $user->offer_letter_signed])); ?>"
                                            target="_blank"
                        ...
                        <form action="<?php echo e(route('users.upload-signed-letter', $user->id)); ?>" method="POST"
                            ...
                            <button type="submit"
                                ...
                                <?php echo e($user->offer_letter_signed ? 'Change Signed Letter' : 'Upload Signed Letter'); ?>

                            </button>
                        </form>
                    </div>
                <?php elseif($user->offer_letter_signed): ?>
                    <div class="info-card scroll-reveal bg-white rounded-3xl p-6">
                        <h3 class="font-black text-slate-900 mb-4 flex items-center gap-2">
                            <span class="w-2 h-6 bg-emerald-500 rounded-full"></span>
                            Verified Offer Letter
                        </h3>
                        <a href="<?php echo e(route('storage.bridge', ['path' => $user->offer_letter_signed])); ?>" target="_blank"
                ...
                <div class="info-card scroll-reveal bg-white rounded-3xl p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $user->activityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex gap-3 group">
                                <div class="flex flex-col items-center flex-shrink-0">
                                    <div class="timeline-dot w-3 h-3 rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 ring-4 ring-indigo-50 group-hover:ring-indigo-100 transition-all"
                                        style="animation-delay: <?php echo e($index * 0.3); ?>s"></div>
                                    <?php if(!$loop->last): ?>
                                ...
                                <div class="pb-1 flex-1 min-w-0">
                                    <p class="text-xs font-bold text-slate-800 leading-snug mb-0.5"><?php echo e($log->description); ?></p>
                                    <p class="text-[10px] text-slate-400 font-medium"><?php echo e($log->created_at->diffForHumans()); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function togglePlainPassword() {
            ...
            const plainValue = <?php echo json_encode($user->password_plain, 15, 512) ?>;
        ...
        function toggleAccountNumber() {
            ...
            const fullValue = <?php echo json_encode($user->bankDetails?->account_number, 15, 512) ?>;
        ...
        function updateFinancePermission(permission) {
            ...
            fetch("<?php echo e(route('users.finance-permission', $user->id)); ?>", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/users/show.blade.php ENDPATH**/ ?>