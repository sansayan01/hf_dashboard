            ...
            <div style="display: flex; align-items: flex-start; gap: 10px; margin-bottom: 16px;">
                ...
                <div class="bot-msg-bubble"
                    ...
                    <p style="margin:0; font-size: 13px; line-height: 1.5;">Hello
                        <?php echo e(explode(' ', auth()->user()->profile->full_name ?? 'there')[0]); ?>! I am your HF Assistant.
                        How
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        aiForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch("<?php echo e(route('ai.chat')); ?>", {
                    method: 'POST',
                    headers: {
        ...
        if (trainBtn && trainPanel) {
            ...
            trainSaveBtn.addEventListener('click', async () => {
                ...
                try {
                    const res = await fetch("<?php echo e(route('ai.training.store')); ?>", {
                        method: 'POST',
            ...
            async function loadTrainingEntries() {
                try {
                    const res = await fetch("<?php echo e(route('ai.training.index')); ?>");
...
</style><?php /**PATH C:\xampp\htdocs\HF\resources\views/layouts/partials/ai_assistant.blade.php ENDPATH**/ ?>