                ...
                <?php if($appointment->survey): ?>
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-500 font-bold uppercase tracking-tight mt-0.5">
                            <?php echo e($appointment->survey->patient_id); ?></p>
                    </div>
                <?php else: ?>
                    <div
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/appointments/partials/table.blade.php ENDPATH**/ ?>