    ...
    <tr class="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors group">
        ...
        <?php if(auth()->user()->designation !== 'staff'): ?>
            <td class="p-6">
                ...
                <?php elseif(auth()->user()->designation !== 'staff'): ?>
                    <a href="<?php echo e(route('patients.membership', $survey->id)); ?>"
        ...
        <td class="p-6">
            <?php if($survey->health_issues): ?>
                <div
                    ...
                    <span
                        class="text-[10px] font-black uppercase tracking-wider"><?php echo e(Str::limit($survey->health_issues, 20)); ?></span>
                </div>
            <?php else: ?>
                <span
        ...
        <td class="p-6">
            <div class="flex items-center space-x-1">
                <a href="<?php echo e(route('patients.appointments.create', $survey->id)); ?>"
                ...
                <a href="<?php echo e(route('patients.appointments.index', $survey->id)); ?>"
        ...
        <td class="p-6">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <?php if(auth()->user()->isSuperAdmin()): ?>
                        <a href="<?php echo e(route('users.show', $survey->creator->id)); ?>"
                    ...
                    <?php else: ?>
                        <p class="text-xs font-bold text-slate-700 dark:text-slate-200">
                            <?php echo e($survey->creator->profile->full_name ?? 'Unknown'); ?></p>
                    <?php endif; ?>
        ...
        <td class="p-6 text-right">
            <?php if(Auth::id() === $survey->created_by || Auth::user()->canAccess($survey->creator)): ?>
                <div class="flex items-center justify-end space-x-2">
                    ...
                    <form action="<?php echo e(route('surveys.destroy', $survey->id)); ?>" method="POST" class="inline-block"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/surveys/partials/table.blade.php ENDPATH**/ ?>