        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-8">
                <div class="relative group">
                    <!-- Outer Glow -->
                    <div
                        class="absolute -inset-1 bg-gradient-to-r from-accent/20 to-purple-500/20 rounded-[3rem] blur opacity-25 group-hover:opacity-60 transition duration-700">
                    </div>

                    <div
                        class="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-10 overflow-hidden shadow-2xl shadow-slate-200/50 dark:shadow-none">
                        ...
                        <form action="<?php echo e(route('coupons.store')); ?>" method="POST" id="couponGenerationForm">
                            ...
                            <div class="mb-10 relative">
                                <div class="flex items-center gap-3 mb-4">
                                    <div
                                        class="w-8 h-8 rounded-full bg-accent text-white flex items-center justify-center font-black text-xs shadow-lg shadow-accent/20">
                                        1</div>
                                    <label for="quantity"
                                        class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Issuance
                                        Volume</label>
                                </div>
                                <div class="relative">
                                    <i
                                    ...
                                    <div class="absolute right-6 top-1/2 -translate-y-1/2 flex gap-4">
                                        <span
                                            class="px-3 py-1 bg-accent/10 text-accent rounded-lg text-[10px] font-black uppercase tracking-tighter self-center">Single
                                            to Bulk</span>
                                    </div>
                                </div>
                                <p
                                    class="mt-3 ml-12 text-[9px] font-bold text-slate-400 uppercase tracking-tighter leading-relaxed italic">
                            ...
                            <div class="mb-10 relative">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <label for="designation"
                                        class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Eligibility
                                        Filtering (Tier Control)</label>
                                </div>
                                <div class="relative">
                                    <i
                                        class="fas fa-user-shield absolute left-6 top-1/2 -translate-y-1/2 text-slate-300 pointer-events-none"></i>
                                    <select
                                    ...
                                    <i
                                        class="fas fa-chevron-down absolute right-6 top-1/2 -translate-y-1/2 text-slate-300 pointer-events-none text-xs"></i>
                                </div>
                            </div>
                                ...
                                <div class="relative">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <label for="expires_at"
                                            class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Lifecycle
                                            Expiry</label>
                                    </div>
                                    <div class="relative">
                                        <i
                                ...
                                <div class="relative">
                                    <div class="flex items-center gap-3 mb-4">
                                        <div
                                            ...
                                            4</div>
                                        <label for="notes"
                                            class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Administrative
                                            Context</label>
                                    </div>
                                    <div class="relative">
                                        <i
                                            class="fas fa-pen-nib absolute left-6 top-[28px] text-slate-300 pointer-events-none"></i>
                                        <textarea
                            ...
                            <div class="mt-12">
                                <button type="submit"
                                    class="w-full group relative py-6 overflow-hidden rounded-[2rem] bg-slate-900 border border-white/10 shadow-2xl transition-all hover:scale-[1.01] active:scale-95">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-r from-accent to-purple-600 opacity-90 group-hover:opacity-100 transition-opacity">
                                    </div>
                                    <div
                                        class="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-from)_0%,_transparent_70%)] from-white/20 to-transparent">
                                    </div>

                                    <span
                                        class="relative z-10 flex items-center justify-center gap-4 text-white font-black text-sm uppercase tracking-[0.2em]">
                                        Execute Generation
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="relative group">
                    <div
                        class="absolute -inset-0.5 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-[2rem] blur opacity-25 group-hover:opacity-40 transition duration-700">
                    </div>
                    <div
                        class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 shadow-xl">
                        <h5
                        ...
                        <div class="space-y-6">
                            <div class="flex gap-4">
                                <div
                                    class="flex-shrink-0 w-8 h-8 rounded-xl bg-slate-50 dark:bg-white/5 flex items-center justify-center text-slate-400">
                                    <i class="fas fa-microchip text-[10px]"></i>
                                </div>
                                <div>
                                    <h6
                                        class="text-[11px] font-black text-slate-700 dark:text-slate-200 uppercase tracking-widest mb-1">
                                        Minter Engine</h6>
                                    <p
                                        class="text-[9px] font-bold text-slate-400 leading-relaxed uppercase tracking-tighter">
                                        System spawns cryptographically unique hashes starting with HF-CASH prefix.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-[9px] font-bold text-slate-400 leading-relaxed uppercase tracking-tighter">
                                        Export codes to encrypted CSV for physical printing or area manager dispatch.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-[9px] font-bold text-slate-400 leading-relaxed uppercase tracking-tighter">
                                        Once validated on registration, the hash is burned and permanently logged.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative group">
                    <div
                        class="absolute -inset-0.5 bg-gradient-to-br from-accent/20 to-indigo-500/20 rounded-[2rem] blur opacity-20 group-hover:opacity-40 transition duration-700">
                    </div>
                    <div
                        class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 shadow-xl text-center overflow-hidden">
                        <div class="absolute -bottom-6 -right-6 w-24 h-24 bg-accent/5 rounded-full blur-2xl"></div>
                        <h5 class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Generated Payload
                            Structure</h5>

                        <div
                            class="p-4 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5 mb-4">
                        ...
                        <p class="text-[8px] font-bold text-slate-300 uppercase tracking-widest leading-loose">
                            ...
                            <span class="text-accent underline decoration-dotted">HF-CASH</span> [Minter ID] • <span
                                class="text-indigo-400 underline decoration-dotted">XXXXX</span> [Auth Key]
                        </p>
                    </div>
                </div>
                ...
                <div class="relative group">
                    <div
                        class="absolute -inset-0.5 bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-[2rem] blur opacity-10 group-hover:opacity-30 transition">
                    </div>
                    <div
                        class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 shadow-xl">
                        <h5 class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Monetary Tier
                            Mapping</h5>

                        <div class="space-y-4">
                            <div
                                class="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5">
                                <span
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Membership
                                    (MEM)</span>
                                <span class="text-xs font-black text-slate-800 dark:text-white">₹200.00</span>
                            </div>
                            <div
                                class="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5">
                                <span
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Officer
                                    (RO)</span>
                            ...
                            <div
                                class="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5">
                                <span
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Manager
                                    (RM)</span>
                            ...
                            <div
                                class="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5">
                                <span
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Block/Dist
                                    (BM/DM)</span>
                        ...
                        <div class="mt-6 flex items-center gap-2">
                            ...
                            <span class="text-[8px] font-bold text-slate-400 uppercase tracking-tighter italic">Vouchers
                                grant 100% discount on joining fees.</span>
                        </div>
                    </div>
                </div>
            </div>
