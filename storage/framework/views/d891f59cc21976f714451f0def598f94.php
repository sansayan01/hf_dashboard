    ...
    <tr class="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors group">
                ...
                <?php if($appointment->survey): ?>
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-500 font-bold uppercase tracking-tight mt-0.5">
                                <?php echo e($appointment->survey->patient_id ?? $appointment->survey->survey_id); ?></p>
                    </div>
                <?php else: ?>
                    <div
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <p class="text-xs font-black text-slate-800 dark:text-white">
                        <?php echo e($appointment->appointment_date->format('Y')); ?></p>
            ...
            <div class="flex items-center space-x-3">
                <div class="w-8 h-8 rounded-lg overflow-hidden ring-2 ring-slate-100 dark:ring-slate-800">
                    <?php if($appointment->creator && $appointment->creator->profile && $appointment->creator->profile->profile_picture): ?>
                        <img src="<?php echo e($appointment->creator->profile->getProfilePictureUrl()); ?>"
                ...
                <div>
                    <?php if(auth()->user()->isSuperAdmin() && $appointment->creator): ?>
                        <a href="<?php echo e(route('users.show', $appointment->creator->id)); ?>"
                    ...
                    <?php else: ?>
                        <p class="text-xs font-bold text-slate-700 dark:text-slate-200">
                            <?php echo e($appointment->creator?->profile?->full_name ?? ($appointment->creator?->employee_id ?? 'Unknown User')); ?>
        ...
        <td class="p-6 text-right space-x-2 whitespace-nowrap">
            <?php if($appointment->status === 'scheduled' && (auth()->user()->isSuperAdmin() || auth()->user()->isOfficeInCharge())): ?>
                <form action="<?php echo e(route('appointments.complete', $appointment->id)); ?>" method="POST" class="inline"
                ...
                <form action="<?php echo e(route('appointments.report_missed', $appointment->id)); ?>" method="POST" class="inline"
            ...
            <?php if($appointment->status === 'missed_reported' && (auth()->user()->isSuperAdmin() || auth()->user()->isOfficeInCharge())): ?>
                ...
                <form action="<?php echo e(route('appointments.confirm_missed', $appointment->id)); ?>" method="POST" class="inline"
            ...
            <?php if($appointment->status === 'scheduled' || $appointment->status === 'missed_reported'): ?>
                ...
                <form action="<?php echo e(route('patients.appointments.destroy', $appointment->id)); ?>" method="POST" class="inline"
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('patients.show', $appointment->survey_id)); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views\appointments\partials\table.blade.php ENDPATH**/ ?>