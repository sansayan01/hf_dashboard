<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-6 animate-in fade-in duration-700">
        ...
        <div class="relative mb-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                ...
                <div class="flex items-center gap-3 ml-14 md:ml-0">
                    <a href="<?php echo e(route('coupons.export', request()->query())); ?>"
                    ...
                    <a href="<?php echo e(route('coupons.create')); ?>"
                ...
                <div class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-3xl p-6">
                    ...
                    <div class="mt-4 w-full bg-slate-100 dark:bg-white/5 h-1.5 rounded-full overflow-hidden">
                        <div class="bg-emerald-500 h-full transition-all duration-1000"
                            style="width: <?php echo e($coupons->total() > 0 ? ($stats['unused'] / $coupons->total()) * 100 : 0); ?>%">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-3xl p-6">
                    ...
                    <div class="mt-4 w-full bg-slate-100 dark:bg-white/5 h-1.5 rounded-full overflow-hidden">
                        <div class="bg-blue-500 h-full transition-all duration-1000"
                            style="width: <?php echo e($coupons->total() > 0 ? ($stats['used'] / $coupons->total()) * 100 : 0); ?>%">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-3xl p-6">
                    ...
                    <div class="mt-4 w-full bg-slate-100 dark:bg-white/5 h-1.5 rounded-full overflow-hidden">
                        <div class="bg-amber-500 h-full transition-all duration-1000"
                            style="width: <?php echo e($coupons->total() > 0 ? ($stats['expired'] / $coupons->total()) * 100 : 0); ?>%">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div
            ...
            <form id="filterForm" method="GET" action="<?php echo e(route('coupons.index')); ?>"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="status"
                        ...
                        <option value="unused" <?php echo e(request('status') == 'unused' ? 'selected' : ''); ?>>Available (Unused)
                        </option>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="designation"
                        ...
                        <option value="membership" <?php echo e(request('designation') == 'membership' ? 'selected' : ''); ?>>Membership
                            (₹199)</option>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody id="tableBody" class="divide-y divide-slate-50 dark:divide-white/5">
                                <?php echo $__env->make('admin.coupons.partials.table', ['coupons' => $coupons], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <?php if($coupons->hasPages()): ?>
                            <div class="px-8 py-6 border-t border-slate-50 dark:border-white/5 bg-slate-50/30 dark:bg-white/5">
                                <div
                                    ...
                                    <div>Showing <?php echo e($coupons->firstItem()); ?> - <?php echo e($coupons->lastItem()); ?> of <?php echo e($coupons->total()); ?>
