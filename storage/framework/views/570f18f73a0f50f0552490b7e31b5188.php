<?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors group">
        ...
        <td class="p-6">
            <div class="space-y-1">
                <p class="text-xs font-black text-slate-700 dark:text-slate-200"><?php echo e($patient->patient_id); ?></p>
                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest"><?php echo e(ucfirst($patient->gender)); ?>
        ...
        <td class="p-6">
            <div class="space-y-1">
                <p class="text-xs font-bold text-slate-600 dark:text-slate-300"><?php echo e($patient->phone_number); ?></p>
                <p class="text-[10px] text-slate-400 font-medium truncate max-w-[150px]"><?php echo e($patient->address); ?></p>
            </div>
        </td>
        <td class="p-6">
            <p class="text-xs font-bold text-slate-600 dark:text-slate-300"><?php echo e($patient->created_at->format('d M, Y')); ?></p>
        ...
        <td class="p-6 text-right">
            <div class="flex items-center justify-end space-x-2">
                ...
                <?php if(auth()->user()->isSuperAdmin()): ?>
                    <form action="<?php echo e(route('patients.membership.cancel', $patient->id)); ?>" method="POST"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/membership/partials/table.blade.php ENDPATH**/ ?>