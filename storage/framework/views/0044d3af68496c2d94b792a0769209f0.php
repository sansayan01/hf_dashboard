    ...
    <tr>
        ...
        <td class="text-right">
            <span class="font-bold text-slate-900 dark:text-white"
                style="font-variant-numeric:tabular-nums">₹<?php echo e(number_format($expense->amount, 2)); ?></span>
        </td>
        <td>
            <span
                class="text-xs font-semibold text-slate-600 dark:text-slate-300"><?php echo e(\App\Models\Expense::PAYMENT_METHODS[$expense->payment_method] ?? $expense->payment_method); ?></span>
        ...
        <td class="text-right">
            <div class="flex items-center justify-end gap-1.5">
                <?php if(auth()->user()->hasPermission('finances.edit_expense')): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\HF\resources\views/expenses/partials/table.blade.php ENDPATH**/ ?>