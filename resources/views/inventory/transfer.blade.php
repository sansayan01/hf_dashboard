...
@section('js')
    ...
    <script>
        ...
        function filterStockSelect(select, fromWhId, tsInstance = null) {
            ...
            // If we have a Tom Select instance, rebuild it with filtered options
            if (tsInstance) {
                ...
                optgroups.forEach(group => {
                    ...
                    const matchingGroupOptions = groupOptions.filter(opt =>
                        opt.dataset.warehouse == fromWhId || fromWhId === ''
                    );

                    if (matchingGroupOptions.length > 0) {
                        matchingGroupOptions.forEach(opt => {
