    ...
    <div class="max-w-2xl mx-auto pb-12">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 font-medium">{{ $income->title }}</p>
            </div>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="number" name="amount" value="{{ old('amount', $income->amount) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select name="category" required class="field-input @error('category') has-error @enderror">
                                ...
                                @foreach(\App\Models\Income::CATEGORIES as $cat)
                                    <option value="{{ $cat }}" {{ old('category', $income->category) == $cat ? 'selected' : '' }}>
                                        {{ $cat }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="income_date"
                                ...
                                max="{{ date('Y-m-d') }}" class="field-input @error('income_date') has-error @enderror"
                                style="font-variant-numeric:tabular-nums">
                            @error('income_date')<p class="text-xs text-rose-500 font-semibold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="received_by" value="{{ old('received_by', $income->received_by) }}"
                            ...
                            @error('received_by')<p class="text-xs text-rose-500 font-semibold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <textarea name="description" rows="2" placeholder="Brief description..."
                                class="field-input resize-none">{{ old('description', $income->description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @if($income->receipt_path)
                                <div class="receipt-badge">
                                    ...
                                    <span class="text-sm font-semibold text-emerald-700 dark:text-emerald-400">Receipt
                                        attached</span>
                                    <a href="{{ url('/storage-render/' . $income->receipt_path) }}" target="_blank"
                            ...
                            <label for="receipt-input" class="dropzone">
                                ...
                                <span id="receipt-label" class="text-sm font-medium text-slate-500 dark:text-slate-400">
                                    {{ $income->receipt_path ? 'Replace receipt' : 'Upload receipt' }}
                                </span>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2" placeholder="Any additional notes..."
                                class="field-input resize-none">{{ old('notes', $income->notes) }}</textarea>
                        </div>
                    </div>
                </div>
