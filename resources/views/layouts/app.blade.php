                        ...
                        <div class="text-right hidden sm:block">
                            ...
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                <div data-live-sync="salary_mode_badge">
                                    {!! ($effectiveUser->salary_mode === 'dab' ? '<span class="text-[9px] font-black text-violet-500 bg-violet-500/10 px-2 py-0.5 rounded-full uppercase tracking-widest border border-violet-500/20">DAB</span>' : '<span class="text-[9px] font-black text-blue-500 bg-blue-500/10 px-2 py-0.5 rounded-full uppercase tracking-widest border border-blue-500/20">TAB</span>') !!}
                                </div>
                            </div>
                        </div>
