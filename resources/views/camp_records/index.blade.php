    ...
    <div class="max-w-7xl mx-auto pb-12">
        ...
        <div class="mb-8" id="filter-wrapper">
            ...
            <div id="filter-panel"
                ...
                <form method="GET" action="{{ route('camp_records.index') }}">
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                    ...
                                    <td class="p-5 align-middle text-right min-w-[140px]">
                                        <div class="flex flex-col items-end space-y-1">
                                            <div class="flex items-center justify-between w-full space-x-3 text-xs">
                                                ...
                                                <span
                                                    class="font-bold text-slate-800 dark:text-slate-200 font-mono">{{ number_format($record->buying_percentage, 1) }}%</span>
                                            </div>
                                    ...
                                    <td class="p-5 align-middle text-right">
                                        <div
                                            ...
                                            <a href="{{ route('camp_records.pdf', $record->id) }}?preview=1"
                                                target="_blank"
                                            ...
                                            <a href="{{ route('camp_records.pdf', $record->id) }}"
