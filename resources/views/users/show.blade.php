                ...
                <div class="flex flex-col lg:flex-row lg:items-start gap-6">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @if(auth()->user()->hasPermission('dashboard.view_as') && auth()->user()->canAccess($user) && auth()->user()->id !== $user->id)
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="info-card scroll-reveal bg-white rounded-3xl p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @if(auth()->user()->isSuperAdmin() && $user->employee_id !== 'HFSA000001')
                            <div
...
@section('js')
    <script>
        ...
        function resetAndRevealPassword() {
            ...
            fetch("{{ route('users.reset-reveal-password', $user->id) }}", {
                method: 'POST',
                headers: {
