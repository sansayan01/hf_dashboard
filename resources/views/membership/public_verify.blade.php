...
<body>
    ...
    <div class="container pb-5">
        <div class="verification-card">
            ...
            @if($isValid && $patient)
                ...
                <div class="profile-header">
                    <div class="member-name">{{ strtoupper($patient->full_name) }}</div>
                    <div class="member-id-pill">ID: {{ $patient->patient_id }}</div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="data-item">
                                ...
                                <div class="data-content">
                                    ...
                                    <div class="data-val">{{ $patient->relative_name ?: 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="data-item">
                                ...
                                <div class="data-content">
                                    ...
                                    <div class="data-val">{{ $patient->age }}Y / {{ strtoupper(substr($patient->gender, 0, 1)) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="data-item">
                                ...
                                <div class="data-content">
                                    ...
                                    <div class="data-val blood-highlight">{{ $patient->blood_group ?: 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="data-item">
                                ...
                                <div class="data-content">
                                    ...
                                    <div class="data-val">+91 {{ $patient->phone_number }}</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="data-item">
                                ...
                                <div class="data-content">
                                    ...
                                    <div class="data-val" style="font-size: 0.9rem;">
                                        {{ $patient->aadhar_number ? implode(' ', str_split($patient->aadhar_number, 4)) : 'N/A' }}
                                        @if($patient->pan_number) <span class="text-muted mx-1">|</span> {{ $patient->pan_number }} @endif
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="p-3 bg-light rounded-4" style="border: 1px dashed #cbd5e1;">
                                ...
                                <div class="data-val fw-normal" style="font-size: 0.95rem; line-height: 1.5; color: #475569;">
                                    {{ $patient->address }}, {{ $patient->gp }}, {{ $patient->block }}<br>
                                    {{ $patient->district }}, WB - {{ $patient->pin }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <div class="p-3 bg-white rounded-4" style="border: 1px solid #f1f5f9; min-height: 60px;">
                                <div class="data-val fw-normal text-muted" style="font-size: 0.9rem;">
                                    {{ $patient->health_issues ?: 'No medical alerts or concurrent diseases recorded.' }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="expiry-box">
                    ...
                    <div class="text-end">
                        ...
                        <div class="data-val fw-bold">{{ \Carbon\Carbon::parse($patient->created_at)->addYear()->format('d M Y') }}</div>
                    </div>
                </div>
                ...
                <div class="history-container">
                    ...
                    <div class="history-block">
                        <div class="history-header">
                            ...
                            <div class="history-count">{{ $patient->appointments->count() }}</div>
                        </div>
                        @forelse($patient->appointments->take(3) as $app)
                            <div class="timeline-item">
                                <div class="d-flex justify-content-between">
                                    <div class="fw-bold">{{ $app->doctor_type }}</div>
                                    <div class="text-muted small">{{ \Carbon\Carbon::parse($app->appointment_date)->format('d M y') }}</div>
                                </div>
                                <div class="text-muted extra-small">{{ $app->location }}</div>
                            </div>
                        @empty
                    ...
                    <div class="history-block">
                        <div class="history-header">
                            ...
                            <div class="history-count">{{ $patient->medicineDistributions->count() }}</div>
                        </div>
                        @forelse($patient->medicineDistributions->take(3) as $dist)
                            <div class="timeline-item">
                                <div class="d-flex justify-content-between">
                                    <div class="fw-bold">Rx Dist #{{ $dist->id }}</div>
                                    <div class="text-muted small">{{ $dist->created_at->format('d M y') }}</div>
                                </div>
                                <div class="text-muted extra-small">
                                    @php $meds = $dist->items->pluck('medicine.name')->toArray(); @endphp
                                    {{ implode(', ', array_slice($meds, 0, 3)) }}@if(count($meds) > 3)... @endif
                                </div>
                            </div>
                        @empty
                    ...
                    <div class="history-block mb-0">
                        <div class="history-header">
                            ...
                            <div class="history-count">{{ $patient->pathologyTests->count() }}</div>
                        </div>
                        @forelse($patient->pathologyTests->take(3) as $test)
                            <div class="timeline-item">
                                <div class="d-flex justify-content-between">
                                    <div class="fw-bold">{{ $test->test_name }}</div>
                                    <div class="text-muted small">{{ $test->date->format('d M y') }}</div>
                                </div>
                            </div>
                        @empty
        ...
        <div class="text-center text-platinum opacity-50 small mt-4">
            &copy; {{ date('Y') }} Humanity Foundation, West Bengal<br>
            Secure Blockchain Verification Node: HF-{{ strtoupper(bin2hex(random_bytes(4))) }}
        </div>
    </div>
