...
@section('header_title', 'Membership Management')
    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
            <div
                ...
                <h3 class="text-3xl font-black text-slate-800 dark:text-white leading-none">{{ $patients->total() }}</h3>
            ...
            <div
                ...
                <h3 class="text-3xl font-black text-slate-800 dark:text-white leading-none">
                    {{ $patients->filter(fn($p) => $p->created_at >= now()->subMonth())->count() }}</h3>
            ...
            <div
                ...
                <h3 class="text-3xl font-black text-slate-800 dark:text-white leading-none">{{ $patients->filter(fn($p) => $p->appointments->isNotEmpty())->count() }}</h3>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
            ...
            <div class="flex items-center space-x-3">
                <form action="{{ route('membership.index') }}" method="GET" class="relative no-loader">
        ...
        @if($patients->isEmpty())
            <div
                ...
                <p class="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-10 font-medium leading-relaxed">
                    Members will appear here once registered via their patient profile. All surveys and regular patients are managed in the <a href="{{ route('patients.index') }}" class="text-accent hover:underline">Patients</a> section.
                </p>
            </div>
        @else
            <div
